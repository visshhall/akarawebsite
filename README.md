## Variant editor GST pricing, auto-selecting an available size, and stock status shown everywhere (6 Sep 2026)
...
---
## robots.txt and sitemap.xml — a real, thorough, direct review (5 Sep 2026)
...
---
## Correction: a colour-only variant must never override the real Basics price (5 Sep 2026)
...
---
## Confirmed colour + size work together; found and fixed a real, live pricing bug across every product listing (5 Sep 2026)
...
---
## A real, proper Small/Medium/Large size editor in the admin panel, with structured dimension boxes (5 Sep 2026)
...
---
## Checkout failing for real, in-stock products with a fake size option; admin price confusion; a confusing variants editor (5 Sep 2026)
...
---
## Admin Settings page — fixed the real, left-hugging layout on wide screens (5 Sep 2026)
...
---
## Real product photos in the cart sidebar and full cart page (5 Sep 2026)
...
---
## Android mobile app integration — Bearer auth and the real APK update channel (5 Sep 2026)
...
---
## Real "Ā" macron support in generated PDFs, via an embedded font (5 Sep 2026)
...
---
## GST-inclusive customer pricing, admin round-off pricing tool, and per-product cost/profit tracking (5 Sep 2026)
