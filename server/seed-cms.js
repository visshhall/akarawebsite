...
export const PAGES = {
  ...
  about: [
    ...
    { type: "paragraph", content: "Lead times are honest: typically two to three weeks because making begins with your order. We would rather wait with you than pretend a shelf full of pre-made stock exists." },
    { type: "stepGrid", content: JSON.stringify({
      ...
      steps: [
        ...
        { number: "05", title: "Ship", description: "Typically 2–3 weeks because the piece starts when you order — not because stock is waiting in a warehouse." },
      ],
    }) },
  ...
  craft: [
    ...
    { type: "paragraph", content: "Most orders reach you in about two to three weeks. That window exists because the piece starts when you order — design is already done; print, finish, and pack still take real studio time. It is not a warehouse delay dressed up as craft." },
