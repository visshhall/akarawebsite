...
export const PAGES = {
  privacy: [
    ...
    { type: "paragraph", content: "Order information: name, email, phone number, shipping and billing address. Account information: email and any profile details you add. Payment information: processed entirely by Razorpay — we never see or store your card, UPI, or bank details. Browsing data: when you are signed in, cart and wishlist may sync to your account so they work across devices; when signed out, they stay in your browser only." },
    { type: "paragraph", content: "Google Sign-In (optional): if you choose to sign in with Google instead of creating a password, Google shares your name, email address, and profile photo (if you have one) with us — the same information Google shows you on its own consent screen before you approve it. We use this only to create or sign you into your ĀKĀRA account; we don't request access to your Gmail, Google Drive, contacts, or anything else in your Google account, and we never post to your Google account on your behalf." },
    ...
    { type: "paragraph", content: "We share only what's necessary, with: Razorpay (payment processing), our courier partners — Delhivery, BlueDart (DHL), Shiprocket, and India Post (name, address, phone for delivery), Gupshup (WhatsApp order notifications, where you've provided a phone number), Resend (transactional email — order confirmations, password resets), Google (if you choose Google Sign-In, Google verifies your identity for us — see 'Google Sign-In' above; separately, Google Analytics receives anonymous, aggregate browsing behaviour — see our Cookie Policy), Cloudflare (our security and content-delivery provider — sees traffic metadata like IP address for every request, as it does for the vast majority of websites), and tax authorities where legally required for GST compliance. None of these parties are permitted to use your data for their own marketing." },
    ...
    { type: "table", content: JSON.stringify([
      ...
      ["Right to Erasure", "Close your online login and request deletion of active account data. Order records and a sealed compliance archive may be retained for up to 8 years for tax, GST, and legal obligations — not for marketing"],
    ...
    { type: "heading", content: "11. Closing your account" },
    { type: "paragraph", content: "From My Account you may close your login. We remove active access and stop marketing. We retain a sealed archive of details needed for orders, tax, GST, and legal compliance for up to **8 years**. That archive is not used for marketing or advertising. Reviews may remain visible as “Verified Buyer” without your full name." },
    { type: "heading", content: "12. Children's Privacy" },
    ...
    { type: "heading", content: "13. Changes to This Policy" },
  ...
  refund: [
    { type: "paragraph", content: "This Refund & Return Policy applies to purchases from akaraonline.co.in. ĀKĀRA products are made to order. Please read this policy and each product page carefully before you buy. The rules below match how the Site actually works." },
    { type: "heading", content: "1. Cancelling an order (before production)" },
    { type: "paragraph", content: "You may cancel an order yourself on the order tracking page within **10 minutes** of placing it, while the order is still in the earliest fulfilment stage. After that window, or once the piece has moved into studio production, cancellation is not available as a self-service option. Emergency requests after the window must be emailed to us; we will only stop production if the piece has not yet been printed, and we are not obliged to cancel once making has begun." },
    { type: "heading", content: "2. Made to order — no change-of-mind returns" },
    { type: "paragraph", content: "We do not accept returns, exchanges, or refunds because you changed your mind, disliked the colour or texture in your space, ordered the wrong size by mistake after confirming checkout, redecorated, received as a gift you do not want, or no longer wish to keep the piece. Convenience returns are not offered." },
    { type: "heading", content: "3. Returns only after delivery" },
    { type: "paragraph", content: "A return request can be filed on the Site **only after the order status is Delivered**. Orders that are still confirmed, in production, in QC, or in transit are not eligible for a return request. This is enforced automatically." },
    { type: "heading", content: "4. When we will consider a claim" },
    ...
    { type: "heading", content: "5. Strict time limits" },
    ...
    { type: "heading", content: "6. What you must provide" },
    ...
    { type: "heading", content: "7. Inspection and condition" },
    ...
    { type: "heading", content: "8. Return shipping" },
  ...
  shipping: [
    ...
    { type: "paragraph", content: "Nothing on akaraonline.co.in is stocked in advance. Once an order is placed, it enters our production queue and is 3D-printed to order — studio work is usually two to three days, and most pieces reach you in about two weeks depending on the piece and courier. We'll only dispatch once your piece has cleared quality control." },
    ...
    { type: "paragraph", content: "Once dispatched, delivery typically takes 3–7 business days depending on your location, within an overall window of about two weeks from order for most pin codes. Metro cities are usually on the faster end of this range; remote or non-metro pin codes may take slightly longer." },
    ...
    { type: "heading", content: "5a. Cancelling before production" },
    { type: "paragraph", content: "Self-service cancellation is available for **10 minutes** after you place the order, from the order tracking page. After that, the order enters the studio queue. Made-to-order pieces are not held as pre-printed stock; once production has started, the order cannot be cancelled for convenience." },
  ...
  terms: [
    ...
    { type: "paragraph", content: "Every ĀKĀRA piece is 3D-printed to order in our Thane studio using plant-based PLA — nothing is pre-stocked. Studio work is typically two to three days from order confirmation; most pieces are with you in about two weeks including dispatch. Because each item is produced individually rather than pulled from a warehouse, minor natural variation between pieces is expected and is not considered a defect." },
  ...
  faq: [
    ...
    { type: "qa", content: JSON.stringify({"q": "What is your production lead time?", "a": "Every piece is made to order. Studio work is typically two to three days after payment confirmation. Including courier, most orders arrive in about two weeks within India. Exact timing can vary with order volume and the piece."}) },
    ...
    { type: "qa", content: JSON.stringify({"q": "When can I request a return?", "a": "Only after the order is marked Delivered on the Site — and only for verified transit damage, manufacturing defect, wrong item, or a significant mismatch with the written product description. Change-of-mind returns are not accepted. Transit damage must be reported within 48 hours of delivery with photos; other eligible claims within 7 days of delivery."}) },
    { type: "qa", content: JSON.stringify({"q": "Can I change or cancel my order?", "a": "You can cancel yourself on the Track Order page within 10 minutes of placing the order, while it is still in the earliest stage. After that window, production may already be queued — email support@akaraonline.co.in with your order number only for genuine emergencies; we cannot guarantee cancellation once printing has started. Change-of-mind cancellations after the window are not available."}) },
    ...
    { type: "qa", content: JSON.stringify({"q": "How long does delivery take?", "a": "Allow about two weeks from order to delivery for most addresses in India (a few days in the studio, then courier). Tracking is shared once the parcel is handed to the courier after quality control."}) },
  ...
  about: [
    { type: "hero", content: JSON.stringify({
      ...
      subtext: "We make geometric home décor the way we think it should be made — designed, printed, and finished in our own studio. Not bought finished and rebranded.",
    }) },
    ...
    { type: "paragraph", content: "ĀKĀRA is a making practice, not a white-label catalogue. Every form is developed here, printed to order in our Mumbai studio, and checked by hand before it leaves. What you pay for is the work of producing the piece — design time, print hours, finishing, and care — not a margin on something made elsewhere." },
    ...
    { type: "paragraph", content: "We use plant-based PLA chosen for form fidelity — clean edges, stable geometry, and a quieter material story than commodity plastics — not only for cost." },
    { type: "paragraph", content: "Lead times are honest: a few days in the studio, and about two weeks to your door, because making begins with your order. We would rather be clear than pretend warehouse stock exists." },
    { type: "stepGrid", content: JSON.stringify({
      eyebrow: "How a piece is made", heading: "From idea to your door.",
      steps: [
        { number: "01", title: "Design", description: "Forms are designed for additive print — geometry that holds up layer by layer, not copied from mould catalogues." },
        { number: "02", title: "Order", description: "Nothing is produced speculatively. Your order starts the queue." },
        { number: "03", title: "Print", description: "Plant-based PLA in our Mumbai studio. We keep weekly capacity deliberate so finishing stays careful." },
        { number: "04", title: "Finish", description: "Hand-finished and quality-checked before leaving the studio." },
        { number: "05", title: "Ship", description: "A few days to make, then courier — most pieces arrive in about two weeks. The piece starts when you order, not from warehouse stock." },
      ],
    }) },
  ...
  craft: [
    ...
    { type: "heading", content: "Studio-made — not white-labelled" },
    { type: "paragraph", content: "We design the forms. We print them in our Mumbai studio. We finish and inspect each piece before it ships. ĀKĀRA does not buy finished décor from a third party and sell it under our name." },
    { type: "paragraph", content: "That is why lead times are real, why sizes and dimensions are ours to set, and why the price reflects making — material, machine time, hand finishing, and responsibility for the object — rather than a private-label markup." },
    { type: "paragraph", content: "If a piece carries the ĀKĀRA name, it left our workshop. That is the whole point." },
    { type: "cardGrid", content: JSON.stringify({
      cards: [
        { title: "Designed for print", description: "Every form is modelled for additive making — wall thickness, overhangs, and balance planned for layer-by-layer build. These are not injection-mould shapes with a 3D-print badge added later." },
        { title: "Material", description: "Plant-based PLA from renewable sources, not commodity petroleum plastic. Chosen for form fidelity — crisp geometry and a stable finish — as much as for a quieter material footprint." },
        { title: "Machine", description: "Bambu Lab A1 COMBO printers in our studio — fine layer resolution for the geometry we design. Each piece is printed individually for your order, then finished by hand." },
      ],
    }) },
    { type: "darkPanel", content: JSON.stringify({
      eyebrow: "Studio capacity",
      heading: "Based in Thane, Maharashtra — roughly 60 to 90 pieces a month.",
      body: "A deliberate ceiling so finishing stays careful. We do not race volume; we keep the queue small enough that every piece is checked by hand before it ships.",
    }) },
    { type: "heading", content: "Lead time as honesty" },
    { type: "paragraph", content: "Most orders reach you in about two weeks. Studio work is usually two to three days; the rest is careful finishing and courier. The piece starts when you order — it is not a warehouse delay dressed up as craft." },
  ...
  "return-request": [
    ...
    { type: "paragraph", content: "ĀKĀRA pieces are made to order. We do not accept returns because you changed your mind. This form is only for verified transit damage, manufacturing defects, or a wrong item — with evidence. The order must already show as **Delivered** on Track Order; earlier stages cannot file a return." },
    { type: "cardGrid", content: JSON.stringify({ cards: [
      { title: "Delivered first", description: "Only after delivery — Return requests are blocked until the order status is Delivered. Confirmed / production / transit orders are not eligible." },
