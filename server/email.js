...
export async function sendOrderConfirmationEmail(order) {
  ...
  const html = emailWrapper(`
    ...
    <p style="font-size:12px;line-height:1.6;color:rgba(24,54,48,0.65);margin:0 0 16px;">A <strong>Care &amp; Placement</strong> card is attached — keep it with the piece.</p>
  ...
  try {
    ...
    attachments = [{ filename: `AKARA-Care-Placement-${order.orderNumber || "order"}.pdf`, content }];
  } catch (err) {
