...
export async function sendOrderConfirmationEmail(order) {
  ...
  const html = emailWrapper(`
    ...
    <p style="font-size:13px;line-height:1.65;color:rgba(24,54,48,0.72);margin:0 0 16px;">Typical lead time before dispatch: <strong style="color:#183630;">2–3 weeks</strong>. We email at each clear step — production, QC, and when the courier takes over.</p>
...
export async function sendAbandonedCartEmail({ email, name, items }) {
  ...
  const html = emailWrapper(`
    ...
    <p style="font-size:12px;color:rgba(36,62,65,0.55);text-align:center;">Made to order in Mumbai · typically ships in 2–3 weeks</p>
