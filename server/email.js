...
export async function sendOrderConfirmationEmail(order) {
  ...
  const html = emailWrapper(`
    ...
    <p style="font-size:12px;line-height:1.6;color:rgba(24,54,48,0.65);margin:0 0 16px;">Attached: a one-page <strong>Care &amp; Placement</strong> card for your piece — keep it with the form.</p>
...
export async function sendAbandonedCartEmail({ email, name, items }) {
  ...
  const html = emailWrapper(`
    <h1 style="font-size:22px;color:#183630;margin:0 0 8px;">Still with you, ${escapeHtml(first)}</h1>
    <p style="font-size:14px;color:rgba(36,62,65,0.75);line-height:1.7;">
      You left a few pieces in your bag. They remain saved to your account — take your time.
    </p>
    <ul style="padding-left:18px;margin:16px 0;">${lines || "<li style=\"color:rgba(36,62,65,0.75);\">Your saved selection</li>"}</ul>
