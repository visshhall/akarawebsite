...
export async function sendOrderConfirmationEmail(order) {
  ...
  const html = emailWrapper(`
    ...
    <p style="font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#C4A35A;margin:0 0 18px;font-family:Arial,sans-serif;">Order #${order.orderNumber}</p>
  ...
  `, { preheader: `Order #${order.orderNumber} confirmed — ĀKĀRA` });
    let attachments;
  try {
    const content = buildCarePlacementCardBase64(order);
