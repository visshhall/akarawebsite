...
// First-party behaviour beacons (page_view, view_item, …). Must be far higher
// than publicFormRateLimit (10/15m) — a single browse session easily exceeds 10 events.
...
export const lookbookUnlockRateLimit = rateLimit({
  windowMs: 15 * 60 * 1000,
  max: 15,
  standardHeaders: true,
  legacyHeaders: false,
  message: { error: "Too many lookbook attempts. Please try again in a few minutes." },
});
