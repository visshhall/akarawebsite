...
// Exported so other modules (e.g. the admin product-media validator) can
// check whether a given URL genuinely points at this site's own real
// storage, without each one re-reading and re-trimming the raw env var
// itself.
