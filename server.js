...
app.get("/sw.js", (req, res) => {
  ...
  // Prefer public/sw.js (source of truth we bump every release). Fall back
  // to dist only if public is missing — avoids Railway serving a stale
  // dist/sw.js when the build cache did not refresh public assets.
  const fromPublic = path.join(__dirname, "public", "sw.js");
  const fromDist = path.join(__dirname, "dist", "sw.js");
