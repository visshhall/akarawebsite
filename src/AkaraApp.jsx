...
function HomeView({ navigate, cart, setCart, wishlist, toggleWishlist }) {
  ...
  return <div>
    ...
    {!productsLoading&&featured.length>0&&<section className="px-6 md:px-14 py-14 md:py-20 max-w-[1600px] mx-auto">
      <div className="mb-12">
    ...
    {/* NEW COLLECTION — the most recently created real products, capped
        ...
        it. */}
    {!productsLoading&&newCollection.length>=4&&<section className="px-6 md:px-14 py-14 md:py-20 max-w-[1600px] mx-auto" style={{backgroundColor:"rgba(36,62,65,0.03)"}}>
  ...
  return <div>
    ...
    <section className="px-6 md:px-14 max-w-[1600px] mx-auto pb-20">
      <div className="flex gap-8 flex-wrap mb-7" style={{borderBottom:"1px solid rgba(36,62,65,0.12)"}}>
        ...
        {["Description",...(product.keyFeatures?.length>0?["Key Features"]:[]),"Dimensions","Care Guide","Reviews"].map(t=><button key={t} onClick={()=>setTab(t)} className="pb-4 text-[13px] transition-colors"
