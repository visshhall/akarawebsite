...
function Header({ navigate, onOpenDrawer, onOpenCart, cartCount, wishCount, user, authChecked=true, logout, className="" }) {
  ...
  return <header className={"sticky top-0 z-40 grid items-center h-[60px] sm:h-[68px] md:h-[72px] px-4 sm:px-6 md:px-12 relative transition-[background-color,box-shadow,border-color] duration-300 "+className} style={{ gridTemplateColumns:"auto 1fr auto", gap:"16px", backgroundColor:scrolled?"rgba(255,242,223,0.98)":"rgba(255,242,223,0.88)", backdropFilter:scrolled?"blur(24px)":"blur(16px)", borderBottom:scrolled?"1px solid rgba(36,62,65,0.12)":"1px solid rgba(36,62,65,0.06)", boxShadow:scrolled?"0 8px 28px -18px rgba(36,62,65,0.22)":"none" }}>
    ...
    <button type="button" onClick={()=>navigate("home")}
      className="justify-self-center flex items-baseline justify-center gap-1.5 sm:gap-2 focus:outline-none self-center select-none"
  ...
  return <div className="group relative flex flex-col cursor-pointer transition-transform duration-500 ease-out akara-press"
    ...
    <div className="pt-4 flex items-start justify-between gap-2">
      <div>
        ...
        <p className="text-[10.5px] mt-1.5" style={{color:"rgba(36,62,65,0.55)"}}>{isSoldOut?"Currently unavailable":"Made to order · about two weeks to your door"}</p>
      </div>
...
function HomeView({ navigate, cart, setCart, wishlist, toggleWishlist }) {
  ...
  return <div>
    ...
    <section className="relative px-6 py-14 md:py-16 text-center overflow-hidden" style={{backgroundColor:T.teal}}>
      ...
      <p className="relative mx-auto max-w-[36rem] text-[15px] md:text-[16px] leading-[1.85]" style={{color:"rgba(245,240,232,0.88)"}}>
...
function ShopView({ navigate, cart, setCart, wishlist, toggleWishlist, initCategory }) {
  ...
  const filtered=(()=>{
    let list=activeCat==="All"?[...products]:products.filter(p=>p.cat===activeCat || slugifyCategory(p.cat)===slugifyCategory(activeCat));
    if(filterSize){
      list=list.filter(p=>{
  ...
  const filterOpt=(active,onClick,label)=>(
    <button type="button" onClick={onClick}
      className="w-full text-left text-[13px] py-2 pl-3 transition-colors"
      style={{
        color: active ? T.teal : "rgba(36,62,65,0.62)",
        borderLeft: active ? `2px solid ${T.gold}` : "2px solid transparent",
        fontWeight: active ? 500 : 400,
        backgroundColor: active ? "rgba(24,54,48,0.04)" : "transparent",
      }}>{label}</button>
  );
        ...
        <div className="w-full lg:w-[240px] xl:w-[260px] shrink-0">
          ...
          >
            <div className="lg:pr-8 lg:border-r" style={{borderColor:"rgba(36,62,65,0.1)"}}>
              ...
              {/* Scale */}
              <div className="mb-8">
                <p className="text-[10px] tracking-[0.16em] uppercase mb-3" style={{color:"rgba(36,62,65,0.45)"}}>Scale</p>
              ...
              {/* Colour */}
              <div className="mb-8">
                <p className="text-[10px] tracking-[0.16em] uppercase mb-3" style={{color:"rgba(36,62,65,0.45)"}}>Finish colour</p>
                <select value={filterColour} onChange={e=>setFilterColour(e.target.value)}
                  className="w-full text-[13px] py-2.5 px-0 outline-none appearance-none cursor-pointer"
                  style={{
                    border:"none",
              ...
              {/* Availability */}
              <div className="mb-8">
                <p className="text-[10px] tracking-[0.16em] uppercase mb-3" style={{color:"rgba(36,62,65,0.45)"}}>Availability</p>
                <div className="flex flex-col">
              ...
              {/* Price */}
              <div className="mb-2">
                <p className="text-[10px] tracking-[0.16em] uppercase mb-3" style={{color:"rgba(36,62,65,0.45)"}}>Price · ₹ incl. GST</p>
                <div className="flex items-center gap-3">
                  <div className="flex-1">
                    <label className="block text-[10px] mb-1" style={{color:"rgba(36,62,65,0.4)"}}>From</label>
                    <input type="number" inputMode="numeric" min={priceFloor} max={priceCeil}
                      ...
                      className="w-full text-[13px] py-2 outline-none tabular-nums"
                      style={{border:"none",borderBottom:"1px solid rgba(36,62,65,0.18)",borderRadius:0,color:T.teal,background:"transparent"}}
                      aria-label="Minimum price"/>
                  </div>
                  <div className="flex-1">
                    <label className="block text-[10px] mb-1" style={{color:"rgba(36,62,65,0.4)"}}>To</label>
                    <input type="number" inputMode="numeric" min={priceFloor} max={priceCeil}
                ...
                <p className="text-[10.5px] mt-3 leading-relaxed" style={{color:"rgba(36,62,65,0.45)"}}>
  ...
  return <div>
    ...
    <section className="px-6 md:px-14 pt-8 pb-16 max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14">
      ...
      <div>
        ...
        {product.description ? (
          <p className="text-[14px] leading-[1.85] mb-6 whitespace-pre-wrap break-words" style={{color:"rgba(36,62,65,0.78)"}}>
    ...
    <section className="px-6 md:px-14 max-w-[1800px] mx-auto pb-20">
      ...
      <div className="p-6 md:p-10" style={{backgroundColor:T.card,boxShadow:ELEVATION.raised,borderRadius:RADIUS.lg,border:"1px solid rgba(24,54,48,0.08)"}}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
          {[
            ["Material","Plant-based PLA printed in our studio — chosen for form fidelity and stable geometry, not only for cost or trend."],
            ["Designed for print","Geometry planned for additive making — wall, balance, and detail built for layer-by-layer production, not a mould shape with a print label."],
            ["Made to order", product?.dims ? `Printed in our studio to the dimensions listed (${product.dims}). Not white-labelled stock. Typically A few days in the studio, then courier — most pieces reach you in about two weeks.` : "Printed in our studio for your order — a few days of making, then dispatch. Most pieces arrive in about two weeks, not from warehouse stock."],
            ["Studio capacity","We keep weekly output limited so finishing stays careful. Small queue, hand-checked pieces — not mass throughput."],
          ].map(([title,body])=>(
            <div key={title}>
...
function CmsSectionBlocks({blocks, navigate}){
  ...
  return <>{blocks.map(b=>{
    ...
    if(b.blockType==="paragraph") return <section key={b.id} className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 max-w-[1100px] mx-auto w-full pb-8"><Lp c={parseInlineMarkup(b.content,navigate)}/></section>;
