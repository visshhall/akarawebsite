      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        : cart.map(item=>{ const ItemArt=item.Art||PlanterArt; return <div key={item.id+item.size+(item.color||"")} className="flex gap-4 mb-5">
          <div className="w-20 h-20 flex items-center justify-center shrink-0" style={{ backgroundColor:T.card,boxShadow:ELEVATION.raised,borderRadius:RADIUS.md }}>
            <ItemArt className="w-3/5 h-3/5" style={{ color:T.teal,opacity:0.8 }}/>
          </div>
    ...
    <div className="px-8 md:px-14 pt-14 pb-10 max-w-[1600px] mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-10">
        ...
        <div>
          ...
          {["The collection",...CATEGORIES].map((c,i)=><button key={c} onClick={()=>navigate("shop",i===0?null:c)}
...
function ProductCard({ product, navigate, cart, setCart, wishlist, toggleWishlist }) {
  const {id,name,cat,price,Art,media}=product;
...
function HomeView({ navigate, cart, setCart, wishlist, toggleWishlist }) {
  ...
  return <div>
    ...
    <section ref={heroRef} onMouseMove={onMove} className="relative flex flex-col items-center justify-end text-center px-6 overflow-hidden"
      ...
      <p className={`relative z-10 text-[12px] tracking-[0.32em] uppercase mb-7 transition-all duration-700 ${reveal?"opacity-100 translate-y-0":"opacity-0 translate-y-2"}`} style={{color:T.teal}}>{hero.eyebrow}</p>
      ...
      <p className={`relative z-10 mt-8 max-w-[460px] text-[16px] leading-[1.8] transition-all duration-700 delay-200 ${reveal?"opacity-100 translate-y-0":"opacity-0 translate-y-3"}`} style={{color:"rgba(36,62,65,0.75)"}}>
        {hero.subtext}
      </p>
    ...
    <section className="px-6 md:px-14 py-16 md:py-24 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        {CATEGORIES.map(c=>{ const Art=CAT_ART[c]; return <button key={c} onClick={()=>navigate("shop",c)}
          ...
          <div className="w-14 h-14 flex items-center justify-center transition-transform duration-500 group-hover:scale-110" style={{backgroundColor:"rgba(184,147,90,0.12)",borderRadius:RADIUS.sm}}>
            <div className="w-7 h-7" style={{color:T.teal}}><Art/></div>
          </div>
    ...
    {!productsLoading&&featured.length>0&&<section className="px-6 md:px-14 py-16 md:py-24 max-w-[1400px] mx-auto">
      <div className="mb-10 md:mb-14">
        <p className="text-[12px] tracking-[0.3em] uppercase mb-3" style={{color:T.teal}}>Curated</p>
        ...
        <div className="w-10 h-px mt-4" style={{backgroundColor:T.gold}}/>
      </div>
      {(()=>{
        ...
        return <>
          {/* Magazine spread: large hero + caption. Responsive: stacks on mobile, side-by-side from md. */}
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center mb-12 md:mb-16">
            <button type="button" onClick={()=>navigate("product",hero.id)}
              className="md:col-span-7 relative overflow-hidden group text-left w-full"
              style={{aspectRatio:"4/5",maxHeight:"640px",backgroundColor:T.card,boxShadow:ELEVATION.raised,borderRadius:RADIUS.lg}}>
              {heroImg
                ? <img src={heroImg} alt={hero.name} className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-[1.03]" loading="eager"/>
                : <div className="w-full h-full flex items-center justify-center">{HeroArt&&<HeroArt className="w-1/3 h-1/3" style={{color:T.teal,opacity:0.5}}/>}</div>}
            </button>
            <div className="md:col-span-5 flex flex-col justify-center">
              <p className="text-[11px] tracking-[0.2em] uppercase mb-3" style={{color:"rgba(36,62,65,0.55)"}}>Featured</p>
              <h3 className="italic text-[28px] md:text-[36px] leading-tight mb-3" style={{fontFamily:"'Fraunces',serif",fontWeight:400,color:T.teal}}>{hero.name}</h3>
              <p className="text-[12px] tracking-[0.08em] uppercase mb-4" style={{color:"rgba(36,62,65,0.6)"}}>{hero.cat}</p>
              {hero.description&&<p className="text-[14.5px] leading-[1.75] mb-5 max-w-md" style={{color:"rgba(36,62,65,0.72)"}}>{String(hero.description).slice(0,160)}{String(hero.description).length>160?"…":""}</p>}
              <p className="text-[22px] mb-6" style={{fontFamily:"'Fraunces',serif",color:T.teal}}>₹{Number(hero.price).toLocaleString("en-IN")}</p>
              <div>
                <SweepButton filled onClick={()=>navigate("product",hero.id)}>View piece</SweepButton>
              </div>
            </div>
          </div>
          {supports.length>0&&(
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
              {supports.map(p=><ProductCard key={p.id} product={p} navigate={navigate} cart={cart} setCart={setCart} wishlist={wishlist} toggleWishlist={toggleWishlist}/>)}
            </div>
          )}
        </>;
      })()}
    ...
    {/* Process — craft story without requiring photography */}
    <section className="px-6 md:px-14 py-16 md:py-24 max-w-[1200px] mx-auto">
      <div className="text-center mb-12 md:mb-16">
        <p className="text-[12px] tracking-[0.3em] uppercase mb-4" style={{color:T.teal}}>How a piece is made</p>
        <h2 className="italic text-[28px] md:text-[36px] mb-3" style={{fontFamily:"'Fraunces',serif",fontWeight:400,color:T.teal}}>Nothing is printed until you order it.</h2>
        <div className="mx-auto w-12 h-px" style={{backgroundColor:T.gold}}/>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
        {[
          ["01","Design","Form tested for balance, light, and quiet drama."],
          ["02","Print","Plant-based PLA, layer by layer in our Mumbai studio."],
          ["03","Finish","Edges and fit hand-checked before packing."],
          ["04","Dispatch","Packed with care — typically 2–3 weeks to ship."],
        ].map(([num,title,desc])=>(
          <div key={num} className="text-center md:text-left">
            <p className="text-[13px] tracking-[0.12em] mb-3" style={{color:T.gold,fontFamily:"'Fraunces',serif"}}>{num}</p>
            <p className="text-[16px] mb-2" style={{fontFamily:"'Fraunces',serif",fontStyle:"italic",color:T.teal}}>{title}</p>
            <p className="text-[12.5px] leading-[1.6]" style={{color:"rgba(36,62,65,0.72)"}}>{desc}</p>
          </div>
        ))}
      </div>
    </section>
...
function ShopView({ navigate, cart, setCart, wishlist, toggleWishlist, initCategory }) {
  ...
  return <div>
    <section className="px-6 md:px-14 pt-14 pb-8 text-center">
      ...
      {catInfo&&<p className="max-w-[560px] mx-auto text-[14px] leading-[1.8]" style={{color:"rgba(36,62,65,0.75)"}}>{catInfo.intro}</p>}
    </section>
  ...
  return <div>
    ...
    <section className="px-6 md:px-14 pt-8 pb-16 max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14">
      ...
      <div>
        ...
        <p className="text-[11.5px] mb-2" style={{color:"rgba(36,62,65,0.75)"}}>Excl. GST · added at checkout</p>
        ...
        {soldOut?<div className="flex items-center gap-2.5 px-4 py-3 mb-7 text-[12.5px]" style={{backgroundColor:"rgba(192,57,43,0.07)",color:T.error}}>
          ...
          <span style={{color:T.teal}}>●</span> Handcrafted for you — ships in 2–3 weeks
        </div>}
      ...
      <div>
        {cart.map(item=>{ const ItemArt=item.Art||PlanterArt; return <div key={item.id+item.size+(item.color||"")} className="flex gap-5 py-6" style={{borderBottom:"1px solid rgba(36,62,65,0.1)"}}>
          <div className="w-24 h-24 flex items-center justify-center shrink-0" style={{backgroundColor:T.card,boxShadow:ELEVATION.raised,borderRadius:RADIUS.md}}>
            <ItemArt className="w-1/2 h-1/2" style={{color:T.teal,opacity:0.8}}/>
          </div>
...
function CheckoutView({ navigate, cart, setCart, setOrder, appliedCoupon, setAppliedCoupon, user, setPostLoginRedirect }) {
  ...
  if(!user) return <div className="px-6 py-24 max-w-[440px] mx-auto text-center">
    ...
    <p className="text-[14px] leading-[1.8] mb-9" style={{color:"rgba(36,62,65,0.75)"}}>
...
function MyAccountView({ navigate, wishlist, user, setUser, order, setOrder, initTab }) {
  ...
  return <div className="px-6 md:px-14 py-16 max-w-[1000px] mx-auto">
    <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
      ...
      <p className="text-[13.5px]" style={{color:"rgba(36,62,65,0.75)"}}>Signed in as <strong style={{color:T.teal}}>{user.email}</strong></p>
    </div>
    ...
    {tab==="Profile"&&<div className="max-w-[420px]">
      ...
      <div className="pb-8 mb-8" style={{borderBottom:"1px solid rgba(36,62,65,0.1)"}}>
        <label className="block text-[11px] tracking-[0.08em] uppercase mb-2" style={{color:"rgba(36,62,65,0.75)"}}>Email</label>
        {emailChangeStep==="idle"&&<>
          <input value={user?.email||""} disabled className="w-full bg-transparent outline-none text-[14px] cursor-not-allowed mb-3" style={{border:"1px solid rgba(36,62,65,0.14)",borderRadius:RADIUS.xs,padding:"13px 14px",color:"rgba(36,62,65,0.75)"}}/>
      ...
      <div className="pb-8 mb-8" style={{borderBottom:"1px solid rgba(36,62,65,0.1)"}}>
        <label className="block text-[11px] tracking-[0.08em] uppercase mb-2" style={{color:"rgba(36,62,65,0.75)"}}>Phone</label>
        {phoneChangeStep==="idle"&&<>
          <input value={user?.phone||""} disabled className="w-full bg-transparent outline-none text-[14px] cursor-not-allowed mb-3" style={{border:"1px solid rgba(36,62,65,0.14)",borderRadius:RADIUS.xs,padding:"13px 14px",color:"rgba(36,62,65,0.75)"}}/>
      ...
      <div className="pt-8" style={{borderTop:"1px solid rgba(36,62,65,0.1)"}}>
        <p className="text-[13px] mb-4" style={{color:"rgba(36,62,65,0.75)"}}>Password</p>
      ...
      <div className="pt-8" style={{borderTop:"1px solid rgba(36,62,65,0.1)"}}>
        ...
        <p className="text-[12px] mb-4" style={{color:"rgba(36,62,65,0.75)"}}>Permanently deletes your profile, saved addresses, and wishlist. Your order history is kept for legal/tax record-keeping, no longer linked to your name. Any product reviews you've written stay visible as "Verified Buyer." This can't be undone.</p>
...
function ReturnRequestView({ navigate, order, user }){
  ...
  return <div className="px-6 md:px-14 py-16 max-w-[600px] mx-auto">
    ...
    <p className="text-[13.5px] leading-[1.8] mb-10 text-center" style={{color:"rgba(36,62,65,0.75)"}}>7-day return window for damaged, defective, or significantly-different-than-described pieces. A photo of the issue helps us review your request faster.</p>
