...
function Header({ navigate, onOpenDrawer, onOpenCart, cartCount, wishCount, user, authChecked=true, logout, className="" }) {
  ...
  return <header className={"sticky top-0 z-40 grid items-center h-[76px] px-6 md:px-12 relative transition-[background-color,box-shadow,border-color] duration-300 "+className} style={{ gridTemplateColumns:"auto 1fr auto", gap:"16px", backgroundColor:scrolled?"rgba(255,242,223,0.98)":"rgba(255,242,223,0.88)", backdropFilter:scrolled?"blur(24px)":"blur(16px)", borderBottom:scrolled?"1px solid rgba(36,62,65,0.12)":"1px solid rgba(36,62,65,0.06)", boxShadow:scrolled?"0 8px 28px -18px rgba(36,62,65,0.22)":"none" }}>
    ...
    <button type="button" onClick={()=>navigate("home")}
      className="justify-self-center flex flex-col items-center justify-center focus:outline-none self-center leading-none select-none"
      aria-label="ĀKĀRA home">
      <span className="tracking-[0.02em]" style={{
      ...
      <span className="mt-0.5" style={{
        ...
        color:"rgba(24,54,48,0.55)",
        letterSpacing:"0.12em",
      }}>(आकार)</span>
    </button>
    <div className="justify-self-end flex items-center gap-0.5 sm:gap-1 shrink-0 max-w-[50vw]">
      ...
      {firstImage
        ?<>
          ...
          {cardImages.map((src,i)=>(
            <img key={src+i} src={src} alt={i===0?name:""} loading={i===0?"lazy":"lazy"} decoding="async"
        ...
        :<div className="w-2/5 h-2/5 transition-transform duration-700 ease-out" style={{color:T.teal,opacity:isSoldOut?0.45:0.82,transform:hover?"scale(1.1)":"scale(1)"}}>
        <Art/>
      </div>}
...
function SectionRule({ label }) {
  return <div className="flex items-center justify-center gap-4 px-6 py-0 my-1" aria-hidden>
...
function HomeView({ navigate, cart, setCart, wishlist, toggleWishlist }) {
  ...
  return <div>
    ...
    <section className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-12 md:py-16 max-w-[2000px] mx-auto w-full">
    ...
    {!productsLoading&&featured.length>0&&<section className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-12 md:py-16 max-w-[2000px] mx-auto w-full">
    ...
    {/* NEW COLLECTION — the most recently created real products, capped
        ...
        it. */}
    {!productsLoading&&newCollection.length>=4&&<section className="akara-scroll-hover-area px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-12 md:py-16 max-w-[2000px] mx-auto w-full" style={{backgroundColor:"rgba(36,62,65,0.03)"}}>
  ...
  return <div>
    ...
    <section className="px-6 md:px-10 xl:px-16 pb-24 max-w-[1800px] mx-auto">
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 items-start">
        {/* Sidebar filters */}
        <aside className="w-full lg:w-[240px] xl:w-[260px] shrink-0 lg:sticky lg:top-[96px] lg:self-start" aria-label="Refine the collection">
          <div className="flex items-center justify-between mb-5 lg:mb-6">
            <div>
              <p className="text-[10px] tracking-[0.18em] uppercase mb-1" style={{color:"rgba(36,62,65,0.45)"}}>Refine</p>
              <p className="text-[12.5px]" style={{color:"rgba(36,62,65,0.6)"}}>Quiet filters — shareable in the link.</p>
            </div>
            {hasActiveFilters && (
              <button type="button" onClick={clearFilters} className="text-[11px] tracking-[0.08em] uppercase shrink-0" style={{color:T.teal,borderBottom:"1px solid rgba(24,54,48,0.25)"}}>Clear</button>
            )}
          </div>
          <div className="flex flex-col gap-7 p-5 lg:p-0" style={{
            borderRadius:RADIUS.md,
            border:"1px solid rgba(36,62,65,0.1)",
            backgroundColor:"rgba(255,255,255,0.35)",
          }}>
            <div>
              <p className="text-[10px] tracking-[0.12em] uppercase mb-2.5" style={{color:"rgba(36,62,65,0.45)"}}>Scale</p>
            ...
            <div>
              <p className="text-[10px] tracking-[0.12em] uppercase mb-2.5" style={{color:"rgba(36,62,65,0.45)"}}>Finish colour</p>
              <select value={filterColour} onChange={e=>setFilterColour(e.target.value)}
                className="w-full text-[12.5px] px-3 py-2.5 outline-none"
                style={{border:"1px solid rgba(36,62,65,0.18)",borderRadius:RADIUS.xs,color:T.teal,background:T.cream}}>
            ...
            <div>
              <p className="text-[10px] tracking-[0.12em] uppercase mb-2.5" style={{color:"rgba(36,62,65,0.45)"}}>Availability</p>
              <div className="flex flex-wrap gap-1.5">
            ...
            <div>
              <p className="text-[10px] tracking-[0.12em] uppercase mb-2.5" style={{color:"rgba(36,62,65,0.45)"}}>Price (₹, incl. GST)</p>
              <div className="flex items-center gap-2">
                <input type="number" min={100} max={priceCeil} value={priceMin} onChange={e=>setPriceMin(e.target.value)}
                  className="w-full text-[12.5px] px-2.5 py-2 outline-none tabular-nums"
                  style={{border:"1px solid rgba(36,62,65,0.18)",borderRadius:RADIUS.xs,color:T.teal,background:T.cream}}
                  aria-label="Minimum price"/>
                <span style={{color:"rgba(36,62,65,0.4)"}}>—</span>
                <input type="number" min={100} max={priceCeil} value={priceMax} onChange={e=>setPriceMax(e.target.value)}
                  className="w-full text-[12.5px] px-2.5 py-2 outline-none tabular-nums"
                  style={{border:"1px solid rgba(36,62,65,0.18)",borderRadius:RADIUS.xs,color:T.teal,background:T.cream}}
                  aria-label="Maximum price"/>
              </div>
              <p className="text-[10.5px] mt-1.5" style={{color:"rgba(36,62,65,0.5)"}}>Range of this collection: ₹100 – ₹{Number(priceCeil).toLocaleString("en-IN")}</p>
            </div>
          </div>
        </aside>
        ...
        <div className="flex-1 min-w-0 w-full">
          <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
            <p className="text-[12px] tracking-[0.06em]" style={{color:"rgba(36,62,65,0.55)"}}>
              {productsLoading ? "…" : `${filtered.length} piece${filtered.length!==1?"s":""}`}
            </p>
            <label className="flex items-center gap-2 text-[11px] tracking-[0.08em] uppercase" style={{color:"rgba(36,62,65,0.55)"}}>
              Sort
              <select value={shopSort} onChange={e=>setShopSort(e.target.value)}
                className="text-[12.5px] normal-case tracking-normal px-3 py-2 outline-none"
                style={{border:"1px solid rgba(36,62,65,0.18)",borderRadius:RADIUS.xs,color:T.teal,background:T.cream}}>
