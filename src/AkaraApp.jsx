  ...
  return <header className={"sticky top-0 z-40 grid items-center h-[60px] sm:h-[68px] md:h-[72px] px-4 sm:px-6 md:px-12 relative transition-[background-color,box-shadow,border-color] duration-300 "+className} style={{ gridTemplateColumns:"auto 1fr auto", gap:"16px", backgroundColor:scrolled?"rgba(255,242,223,0.98)":"rgba(255,242,223,0.88)", backdropFilter:scrolled?"blur(24px)":"blur(16px)", borderBottom:scrolled?"1px solid rgba(36,62,65,0.12)":"1px solid rgba(36,62,65,0.06)", boxShadow:scrolled?"0 8px 28px -18px rgba(36,62,65,0.22)":"none" }}>
    ...
    <button type="button" onClick={()=>navigate("home")}
      ...
      <img
        ...
        style={{ height:"32px", maxHeight:"40px", maxWidth:"min(38vw, 160px)" }}
        decoding="async"
        draggable={false}
      />
      <span
    ...
    <aside aria-label="Shopping cart" aria-modal={open} role="dialog" className="fixed top-0 right-0 bottom-0 z-[70] flex flex-col transition-transform duration-500"
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {cart.length===0 ? <div className="text-center mt-14 px-4">
          ...
          <p className="text-[13px] mb-6 leading-relaxed" style={{color:"rgba(36,62,65,0.7)"}}>Pieces you add will appear here — made to order, typically 2–3 weeks.</p>
  ...
  return <div className="group relative flex flex-col cursor-pointer transition-transform duration-500 ease-out akara-press"
    ...
    <div className="pt-4 flex items-start justify-between gap-2">
      <div>
        ...
        <p className="text-[10.5px] mt-1.5" style={{color:"rgba(36,62,65,0.55)"}}>{isSoldOut?"Currently unavailable":"Made to order · 2–3 weeks from print"}</p>
      </div>
...
function HomeView({ navigate, cart, setCart, wishlist, toggleWishlist }) {
  ...
  return <div>
    ...
    <section className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-10 md:py-14 max-w-[2000px] mx-auto w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          [Truck,"04","Dispatch","2–3 weeks because making starts with your order."],
    ...
    <section className="relative px-6 py-12 md:py-14 text-center overflow-hidden" style={{backgroundColor:T.teal}}>
      ...
      <div className="relative mt-12 mx-auto max-w-[520px] grid grid-cols-3 border" style={{borderColor:"rgba(255,255,255,0.15)"}}>
        {[["60–90","Pieces / month"],["2–3","Weeks · made to order"],["0","Warehouse stock"]].map(([n,l],i)=><div key={l} className="py-7 px-4" style={{borderRight:i<2?"1px solid rgba(255,255,255,0.15)":"none"}}>
  ...
  return <div>
    <section className="px-6 md:px-14 pt-10 md:pt-12 pb-6 text-center">
      ...
      {activeCat&&activeCat!=="All"&&(
        <p className="max-w-[480px] mx-auto text-[12.5px] mt-4 leading-relaxed" style={{color:"rgba(36,62,65,0.65)"}}>
          Each piece is printed and finished to order in our Mumbai studio — typically 2–3 weeks.
        </p>
      )}
    ...
    <section className="px-6 md:px-10 xl:px-16 pb-24 max-w-[1800px] mx-auto">
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 items-start">
        {/* Sidebar filters */}
        <aside className="w-full lg:w-[220px] xl:w-[240px] shrink-0 lg:sticky lg:top-[80px] lg:self-start" aria-label="Refine the collection">
          <p className="text-[10px] tracking-[0.2em] uppercase mb-1" style={{color:"rgba(36,62,65,0.45)"}}>Refine</p>
          <p className="text-[12px] mb-5 leading-snug" style={{color:"rgba(36,62,65,0.55)"}}>Filters stay in the link when you share.</p>

          <div className="flex flex-col gap-6">
            <div>
              <p className="text-[10px] tracking-[0.14em] uppercase mb-2" style={{color:"rgba(36,62,65,0.5)"}}>Scale</p>
              <div className="flex flex-wrap gap-1.5">
                {chip(!filterSize, ()=>setFilterSize(""), "Any")}
                {["Small","Medium","Large"].map(s=>chip(filterSize===s, ()=>setFilterSize(s), s))}
              </div>
            </div>

            <div>
              <p className="text-[10px] tracking-[0.14em] uppercase mb-2" style={{color:"rgba(36,62,65,0.5)"}}>Finish colour</p>
            ...
            <div>
              <p className="text-[10px] tracking-[0.14em] uppercase mb-2" style={{color:"rgba(36,62,65,0.5)"}}>Availability</p>
              <div className="flex flex-wrap gap-1.5">
                {chip(!filterAvail, ()=>setFilterAvail(""), "Any")}
                {chip(filterAvail==="in", ()=>setFilterAvail("in"), "In studio")}
                {chip(filterAvail==="low", ()=>setFilterAvail("low"), "Few left")}
              </div>
            </div>

            <div>
              <p className="text-[10px] tracking-[0.14em] uppercase mb-2" style={{color:"rgba(36,62,65,0.5)"}}>Price (₹, incl. GST)</p>
              <div className="flex items-center gap-2">
                <input type="number" inputMode="numeric" min={priceFloor} max={priceCeil} placeholder={String(priceFloor)}
                  value={priceMin}
                  onChange={e=>{
                  ...
                  onBlur={()=>{
                    ...
                    n=Math.max(priceFloor, Math.min(priceCeil, n));
                    setPriceMin(String(n));
                  }}
                  className="w-full text-[13px] px-2.5 py-2 outline-none tabular-nums"
                  style={{border:"1px solid rgba(36,62,65,0.16)",borderRadius:RADIUS.xs,color:T.teal,backgroundColor:T.cream}}
                  aria-label="Minimum price"/>
                <span className="shrink-0 text-[12px]" style={{color:"rgba(36,62,65,0.4)"}}>—</span>
                <input type="number" inputMode="numeric" min={priceFloor} max={priceCeil} placeholder={String(priceCeil)}
                  value={priceMax}
                  onChange={e=>{
                    const v=e.target.value.replace(/\D/g,"").slice(0,7);
                    setPriceMax(v);
                  ...
                  onBlur={()=>{
                    ...
                    n=Math.max(priceFloor, Math.min(priceCeil, n));
                    setPriceMax(String(n));
                  }}
                  className="w-full text-[13px] px-2.5 py-2 outline-none tabular-nums"
                  style={{border:"1px solid rgba(36,62,65,0.16)",borderRadius:RADIUS.xs,color:T.teal,backgroundColor:T.cream}}
                  aria-label="Maximum price"/>
              </div>
              <p className="text-[10.5px] mt-2" style={{color:"rgba(36,62,65,0.48)"}}>
                Collection range ₹{priceFloor.toLocaleString("en-IN")} – ₹{Number(priceCeil).toLocaleString("en-IN")}
              </p>
            </div>

            {hasActiveFilters && (
              <button type="button" onClick={clearFilters}
                className="text-[11px] tracking-[0.1em] uppercase self-start pt-1"
                style={{color:T.teal,borderBottom:"1px solid rgba(24,54,48,0.22)"}}>
                Clear all filters
              </button>
            )}
          </div>
    ...
    <section className="px-6 md:px-14 pt-8 pb-16 max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14">
      ...
      <div>
        ...
        {soldOut?<div className="mb-7">
          ...
          <p className="flex items-center gap-2"><span>●</span> Made to order — typically 2–3 weeks because print starts with your order</p>
        ...
        <div className="flex flex-col gap-2.5 text-[12.5px] p-4" style={{color:"rgba(36,62,65,0.78)",backgroundColor:"rgba(24,54,48,0.04)",borderRadius:12,border:"1px solid rgba(24,54,48,0.08)"}}>
          <div className="flex items-center gap-2"><Package size={13} style={{color:T.teal}}/> Made to order · typically 2–3 weeks from print</div>
      ...
      <div className="p-6 md:p-10" style={{backgroundColor:T.card,boxShadow:ELEVATION.raised,borderRadius:RADIUS.lg,border:"1px solid rgba(24,54,48,0.08)"}}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
          {[
            ...
            ["Made to order", product?.dims ? `Printed in our studio to the dimensions listed (${product.dims}). Not white-labelled stock. Typically 2–3 weeks because making starts with your order.` : "Printed in our studio for your order — typically 2–3 weeks because the piece starts when you order, not because it sat in a warehouse."],
...
function OrderStatusView({ navigate, order, setOrder }) {
  ...
  return <div className="px-6 md:px-14 py-16 max-w-[820px] mx-auto">
    ...
    :<>
      <p className="text-[13.5px] mb-6" style={{color:"rgba(36,62,65,0.75)"}}>Made-to-order pieces typically take 2–3 weeks in the studio before they ship. One journey below — studio stages first, then courier once dispatched.</p>
      ...
      :<div className="akara-product-grid grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
        {wishedProducts.map(p=>(
          <div key={p.id} className="relative">
            <button type="button" aria-label={`Remove ${p.name} from wishlist`}
              onClick={(e)=>{ e.stopPropagation(); toggleWishlist?.(p.id); }}
              className="absolute top-2 right-2 z-10 w-8 h-8 flex items-center justify-center"
              style={{backgroundColor:"rgba(255,242,223,0.95)",borderRadius:999,border:"1px solid rgba(36,62,65,0.12)",color:T.teal}}>
              <X size={14}/>
            </button>
            <ProductCard product={p} navigate={navigate} cart={cart||[]} setCart={setCart||(()=>{})} wishlist={safeWishlist} toggleWishlist={toggleWishlist||(()=>{})}/>
          </div>
        ))}
      </div>
    )}
