    ...
    <section className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-16 md:py-24 max-w-[2000px] mx-auto w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
        ...
        return <button key={c} type="button" onClick={()=>navigate("shop",c)}
          className="group flex items-start gap-4 p-5 md:p-6 text-left transition-shadow duration-300"
...
function ReturnRequestView({ navigate, order, user }){
  ...
  return <div className="px-6 md:px-14 py-16 max-w-[720px] mx-auto">
    ...
    <h1 className="italic text-[30px] md:text-[38px] mb-3 text-center" style={{fontFamily:"'Fraunces',serif",color:T.teal}}>Returns, clearly</h1>
    <p className="text-[14px] leading-[1.8] mb-10 text-center max-w-[34rem] mx-auto" style={{color:T.muted}}>Read the policy once — then request a return only if it applies. We review every case with care.</p>

    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
      {[
        ["Window","7 days from delivery","Damaged, defective, or significantly different from the listing."],
        ["What we need","Order number + photo","A clear photo of the issue speeds review — usually within 1–2 working days."],
        ["What we don’t take back","Change of mind","Made-to-order pieces can’t be returned if they match the description and arrive intact."],
      ].map(([t1,t2,t3])=>(
