...
function HomeView({
  const { names: categoryNames, rows: catRows, blurbs: catBlurbs } = useCategories(); navigate, cart, setCart, wishlist, toggleWishlist }) {
  ...
  return <div>
    ...
    {/* Room / mood boards — curated pairings from live catalogue */}
    <section className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-16 md:py-20 max-w-[2000px] mx-auto w-full akara-fade-in">
      <div className="text-center mb-10 md:mb-12">
        <p className="text-[12px] tracking-[0.3em] uppercase mb-4" style={{color:T.gold}}>Room stories</p>
        ...
        <p className="text-[13.5px] mt-3 max-w-lg mx-auto" style={{color:T.muted}}>Quiet pairings from the collection — not random recommendations.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
        {(() => {
          const list = (products||[]).filter(p=>p.status!=="sold-out");
          const boards = [
            { title: "Desk calm", blurb: "A planter and a low form for the work surface.", pick: (arr)=>arr.filter(p=>/planter|desk|tray|organizer/i.test(p.cat+" "+p.name)).slice(0,2) },
            { title: "Evening light", blurb: "Warm light with a quiet companion object.", pick: (arr)=>arr.filter(p=>/lamp|light|lantern|vase/i.test(p.cat+" "+p.name)).slice(0,2) },
            { title: "Entry ritual", blurb: "The first objects you meet at the door.", pick: (arr)=>arr.filter(p=>/vase|planter|bowl|tray/i.test(p.cat+" "+p.name)).slice(0,2) },
            { title: "Shelf dialogue", blurb: "Two forms that share a shelf without competing.", pick: (arr)=>arr.slice().sort((a,b)=>(a.featuredOrder??99)-(b.featuredOrder??99)).slice(0,2) },
          ];
          return boards.map(board=>{
            let pair = board.pick(list);
            if(pair.length<2) pair = list.slice(0,2);
            if(pair.length<2) return null;
            return (
              <div key={board.title} className="p-5 md:p-6 akara-lift" style={{backgroundColor:T.card,borderRadius:RADIUS.md,boxShadow:ELEVATION.raised,border:"1px solid rgba(24,54,48,0.06)"}}>
                  ...
                  {pair.map(p=>{
                    ...
                    return (
                      <button key={p.id} type="button" onClick={()=>navigate("product",p.id)} className="text-left group">
                        <div className="aspect-[4/5] overflow-hidden mb-2" style={{borderRadius:RADIUS.sm,backgroundColor:"rgba(24,54,48,0.06)"}}>
                        ...
                        <p className="text-[12px]" style={{color:T.muted}}>₹{Number(p.price).toLocaleString("en-IN")}</p>
                      </button>
                    );
                  })}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 xl:gap-16 items-center mb-14 md:mb-20">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center lg:pl-2">
              ...
              <div className="mb-8">
                ...
                <p className="text-[11.5px] mt-1" style={{color:"rgba(24,54,48,0.75)"}}>Excl. GST · printed after you order</p>
              </div>
  ...
  return <div>
    ...
    <section className="px-6 md:px-14 pt-8 pb-16 max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14">
      ...
      <div>
        ...
        {Array.isArray(product.finishes) && product.finishes.length>0 && (
          <div className="mb-5">
            <p className="text-[11px] tracking-[0.12em] uppercase mb-2.5" style={{color:T.gold}}>Finish</p>
    ...
    <section className="px-6 md:px-14 max-w-[1800px] mx-auto pb-20">
      ...
      <div className="p-6 md:p-10" style={{backgroundColor:T.card,boxShadow:ELEVATION.raised,borderRadius:RADIUS.lg,border:"1px solid rgba(24,54,48,0.08)"}}>
        <p className="text-[11px] tracking-[0.2em] uppercase mb-2" style={{color:T.gold}}>Why this piece</p>
...
function MyAccountView({ navigate, wishlist, user, setUser, order, setOrder, initTab }) {
  ...
  return <div className="px-6 md:px-14 py-12 md:py-16 max-w-[1100px] mx-auto">
    ...
    {tab==="Profile"&&<div className="max-w-[560px]">
      <div className="mb-6">
        <p className="text-[10px] tracking-[0.16em] uppercase mb-1" style={{color:T.gold}}>Account</p>
      ...
      <div className="mb-5 p-5 md:p-6" style={{backgroundColor:T.card,borderRadius:RADIUS.md,boxShadow:ELEVATION.raised,border:"1px solid rgba(24,54,48,0.07)"}}>
        <p className="text-[10px] tracking-[0.14em] uppercase mb-4" style={{color:T.gold}}>Identity</p>
      ...
      <div className="mb-5 p-5 md:p-6" style={{backgroundColor:T.card,borderRadius:RADIUS.md,boxShadow:ELEVATION.raised,border:"1px solid rgba(24,54,48,0.07)"}}>
        <p className="text-[10px] tracking-[0.14em] uppercase mb-4" style={{color:T.gold}}>Email</p>
      ...
      <div className="mb-5 p-5 md:p-6" style={{backgroundColor:T.card,borderRadius:RADIUS.md,boxShadow:ELEVATION.raised,border:"1px solid rgba(24,54,48,0.07)"}}>
        <p className="text-[10px] tracking-[0.14em] uppercase mb-4" style={{color:T.gold}}>Phone</p>
      ...
      <div className="mb-5 p-5 md:p-6" style={{backgroundColor:T.card,borderRadius:RADIUS.md,boxShadow:ELEVATION.raised,border:"1px solid rgba(24,54,48,0.07)"}}>
        <p className="text-[10px] tracking-[0.14em] uppercase mb-4" style={{color:T.gold}}>Password</p>
...
function ReturnRequestView({ navigate, order, user }){
  ...
  return <div className="px-6 md:px-14 py-16 max-w-[720px] mx-auto">
    ...
    <h1 className="italic text-[30px] md:text-[38px] mb-3 text-center" style={{fontFamily:"'Fraunces',serif",color:T.teal}}>Quality claims only</h1>
    <p className="text-[14px] leading-[1.8] mb-10 text-center max-w-[36rem] mx-auto" style={{color:T.muted}}>ĀKĀRA pieces are made to order. We do not accept returns because you changed your mind. This form is only for verified transit damage, manufacturing defects, or a wrong item — with evidence.</p>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
      {[
        ...
        <div key={t1} className="p-5" style={{backgroundColor:T.card,boxShadow:ELEVATION.raised,borderRadius:RADIUS.md}}>
          <p className="text-[11px] tracking-[0.14em] uppercase mb-2" style={{color:T.gold}}>{t1}</p>
