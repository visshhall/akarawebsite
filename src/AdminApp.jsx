    ...
    <div className="w-full max-w-[760px] grid grid-cols-1 md:grid-cols-[1fr_1.1fr]" style={{borderRadius:RADIUS.lg,overflow:"hidden",boxShadow:ELEVATION.modal}}>
      ...
      <div className="p-8 md:p-10 flex flex-col justify-center" style={{backgroundColor:T.cream}}>
        ...
        {pendingToken?<>
          ...
          <p className="text-[10px] tracking-[0.2em] uppercase mb-2" style={{color:T.gold}}>Studio access</p>
...
function AdminDashboard({ setView }){
  ...
  return <div className="p-5 md:p-8" style={{background:"linear-gradient(180deg,#F7F3EB 0%,#EFE8DC 100%)",minHeight:"100%"}}>
    ...
    <div className="mb-5 p-3 md:p-4 flex flex-wrap gap-2 md:gap-3 items-stretch"
      ...
      {[
        ["Orders today", today.ordersToday, "orders"],
        ["To pack / make", today.toPack, "orders"],
        ["Stuck production", today.stuckProduction, "orders"],
        ["Low stock", today.lowStock, "products"],
        ["Pending returns", today.pendingReturns, "returns"],
        ["Contact (open)", today.openContact, null],
      ].map(([label,val,nav])=>(
...
function ProductEditorPanel({ product, onClose, onSaved }){
  ...
  const save=async()=>{
    ...
    setSaving(true);
    try{
      const body={ name:form.name, category:form.category, price, dims:form.dims, hsn:form.hsn, status:form.status, description:form.description, metaTitle:form.metaTitle, metaDesc:form.metaDesc, media, keyFeatures, accessoriesNote:form.accessoriesNote, finishes };
      const res=isNew
  ...
  return <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto py-8 px-4" style={{backgroundColor:"rgba(36,62,65,0.45)"}} onClick={onClose}>
    <div onClick={e=>e.stopPropagation()} className="w-full max-w-[720px]" style={{backgroundColor:T.card,borderRadius:RADIUS.md,boxShadow:ELEVATION.raised}}>
      <div className="flex items-center justify-between px-6 py-5" style={{borderBottom:"1px solid rgba(36,62,65,0.1)"}}>
        <div>
          <p className="text-[10px] tracking-[0.16em] uppercase mb-1" style={{color:T.gold}}>Catalog</p>
      ...
      <div className="p-6 flex flex-col gap-5 max-h-[70vh] overflow-y-auto">
        {editorSection==="basics" && <div>
          <p className="text-[11px] tracking-[0.1em] uppercase mb-3" style={{color:T.gold}}>Basics</p>
        ...
        {editorSection==="media" && <div>
          <p className="text-[11px] tracking-[0.1em] uppercase mb-3" style={{color:T.gold}}>Media</p>
        ...
        {!isNew&&<div>
          <p className="text-[11px] tracking-[0.1em] uppercase mb-3" style={{color:T.gold}}>Size / colour variants</p>
          <VariantEditor productId={product.id}/>
        </div>}
        <div>
          <p className="text-[11px] tracking-[0.1em] uppercase mb-3" style={{color:T.gold}}>Key features</p>
        ...
        <div>
          <div className="mb-5">
            <p className="text-[11px] tracking-[0.1em] uppercase mb-3" style={{color:T.gold}}>Finish swatches</p>
        ...
        {editorSection==="seo" && <div>
          <p className="text-[11px] tracking-[0.1em] uppercase mb-3" style={{color:T.gold}}>Description & SEO</p>
    ...
    <div className="flex flex-col gap-3">
      {orders.map(o=>{
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4">
          ...
          <div className="flex items-center justify-between md:contents gap-2">
            <span className="text-[15px] md:w-24" style={{color:T.teal}}>₹{o.total.toLocaleString("en-IN")}</span>
