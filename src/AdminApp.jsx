    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
      ...
      <div className="p-5" style={ATELIER_PANEL}>
        ...
        <p className="text-[11px] mt-4 leading-relaxed" style={{color:"rgba(36,62,65,0.55)"}}>
          “Needs attention” is live: pending returns + products marked low-stock + failed/pending payments in the last 14 days. Sold-out is listed above for awareness but is not counted in the number. It is not stuck production (that feeds Studio risk separately).
        </p>
      </div>
    </div>
