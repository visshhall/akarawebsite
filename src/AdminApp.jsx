...
function AdminShell({ admin, view, setView, onLogout, children }){
  ...
  return <div className="min-h-screen w-full flex overflow-x-hidden" style={{backgroundColor:T.cream}}>
    ...
    <main className="flex-1 min-w-0 overflow-x-hidden overflow-y-auto pt-14 md:pt-0" style={ADMIN_PAGE_BG}><div className="w-full max-w-[1400px]">{children}</div></main>
  </div>;
}
