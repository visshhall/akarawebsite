...
const ATELIER_PANEL = {
  backgroundColor: "rgba(247,243,235,0.5)",
  borderRadius: 0,
  boxShadow: "none",
  borderLeft: "2px solid #E5C690",
  borderBottom: "1px solid rgba(24,54,48,0.08)",
};
const ATELIER_ROW = {
    ...
    <div className="mb-8 md:mb-10 w-full">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 flex-1">
          <p className="text-[10px] tracking-[0.22em] uppercase mb-2" style={{ color: T.gold }}>{eyebrow}</p>
          <h1 className="italic text-[28px] md:text-[36px] leading-[1.12]" style={{ fontFamily: "'Fraunces',serif", color: T.teal, fontWeight: 400 }}>{title}</h1>
    ...
    <div className="w-full max-w-[760px] grid grid-cols-1 md:grid-cols-[1fr_1.1fr]" style={{borderRadius:0,overflow:"hidden",boxShadow:ELEVATION.modal,border:"1px solid rgba(24,54,48,0.12)"}}>
      ...
      <div className="p-8 md:p-10 flex flex-col justify-center" style={{backgroundColor:T.cream}}>
        ...
        {pendingToken?<>
          ...
          <p className="text-[10px] tracking-[0.22em] uppercase mb-2" style={{color:T.gold}}>Studio access</p>
    ...
    <div className="flex flex-col gap-3" style={{backgroundColor:"transparent"}}>
      {filtered.map(p=>
        <div key={p.id} className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 py-4 md:py-3.5" style={ATELIER_ROW}>
          <span className="text-[10px] tracking-[0.12em] hidden md:inline shrink-0 w-8" style={{color:"rgba(184,147,90,0.9)"}}>{String(pi+1).padStart(2,"0")}</span>
      ...
      {orders.map((o,oi)=>{
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between gap-2">
            ...
            <span className="text-[10px] tracking-[0.12em] mr-2 hidden sm:inline" style={{color:"rgba(184,147,90,0.85)"}}>{String(oi+1).padStart(2,"0")}</span>
...
function AdminWaitlist(){
  ...
  return <div className="p-5 md:p-8">
    <AdminPageHeader eyebrow="Catalog" title="Restock waitlist" subtitle="Emails collected when a piece is sold out or customers request a restock notice." />
      ...
      {batches.map(b=>(
        <div key={b.id} className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3" style={ATELIER_PANEL}>
          ...
          <div className="flex flex-wrap gap-2">
            {b.status==="open"&&<button type="button" onClick={()=>setStatus(b.id,"in_production")} className="text-[11px] uppercase tracking-[0.06em] px-3 py-1.5" style={{border:`1px solid rgba(24,54,48,0.2)`,borderRadius:999,color:T.teal}}>Start production</button>}
...
function AdminCms(){
  ...
  if(selectedPage) return <div className="p-5 md:p-10 max-w-[880px] mx-auto cms-atelier">
    <div className="mb-8 pb-6" style={{borderBottom:"1px solid rgba(184,147,90,0.35)"}}>
      ...
      <p className="text-[10px] tracking-[0.22em] uppercase mb-2" style={{color:T.gold}}>Atelier copy desk</p>
    ...
    <div className="flex flex-col gap-8 mb-10">
      {blocks.map((b,i)=><div key={i} className="relative pl-5 md:pl-6" style={{borderLeft:`2px solid ${i%2===0?T.gold:"rgba(24,54,48,0.12)"}`}}>
        <div className="flex items-center justify-between mb-3 gap-2">
          <span className="text-[10px] tracking-[0.16em] uppercase" style={{color:T.gold,letterSpacing:"0.16em"}}>{String(i+1).padStart(2,"0")} · {b.blockType}</span>
  ...
  return <div className="p-5 md:p-10 max-w-[960px] mx-auto cms-atelier">
    <div className="mb-10">
      <p className="text-[10px] tracking-[0.22em] uppercase mb-2" style={{color:T.gold}}>Manuscripts</p>
      <h1 className="italic text-[32px] md:text-[40px] leading-[1.1] mb-3" style={{fontFamily:"'Fraunces',serif",color:T.teal,fontWeight:400}}>Site content</h1>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-1">
      {pages.map((p,idx)=>(
        <button key={p.pageKey} type="button" onClick={()=>openPage(p.pageKey)}
          ...
          <span className="text-[11px] tracking-[0.1em] uppercase shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" style={{color:T.gold}}>Open</span>
        </button>
      ))}
    </div>}
  </div>;
...
function AdminTwoFactorSettings(){
  ...
  if(loading) return <div className="p-6" style={ATELIER_PANEL}><Skeleton height={80}/></div>;

  // Real backup-codes-shown-once screen — genuinely can't be reached
  // again after leaving it, by design.
  if(newBackupCodes) return <div className="p-6" style={ATELIER_PANEL}>
  ...
  if(setupData) return <div className="p-6" style={ATELIER_PANEL}>
...
function AdminSettings({ admin }){
  ...
  return <div className="p-5 md:p-8">
    ...
    <div className="p-6 flex flex-col h-full min-h-[280px]" style={ATELIER_PANEL}>
      <p className="text-[10px] tracking-[0.16em] uppercase mb-2" style={{color:T.gold}}>01 · Shipping</p>
    ...
    <div className="p-6 flex flex-col h-full min-h-[280px]" style={ATELIER_PANEL}>
      <p className="text-[10px] tracking-[0.16em] uppercase mb-2" style={{color:T.gold}}>02 · Presence</p>
    ...
    <div className="p-6 flex flex-col h-full min-h-[280px]" style={ATELIER_PANEL}>
      <p className="text-[10px] tracking-[0.16em] uppercase mb-2" style={{color:T.gold}}>03 · Checkout</p>
    ...
    <div className="p-6 flex flex-col h-full min-h-[280px]" style={ATELIER_PANEL}>
      <p className="text-[10px] tracking-[0.16em] uppercase mb-2" style={{color:T.gold}}>04 · Offers</p>
    ...
    <div className="p-6 flex flex-col h-full min-h-[280px]" style={ATELIER_PANEL}>
      <p className="text-[10px] tracking-[0.16em] uppercase mb-2" style={{color:T.gold}}>05 · Dispatch</p>
    ...
    <div className="p-6 flex flex-col h-full min-h-[280px]" style={ATELIER_PANEL}>
      <p className="text-[10px] tracking-[0.16em] uppercase mb-2" style={{color:T.gold}}>06 · Access</p>
    ...
    <div className="md:col-span-2 xl:col-span-3">
      ...
      {admin?.role==="super_admin"&&(
        <div className="p-5 mb-6" style={{...ATELIER_PANEL, borderLeft: salesPaused ? "2px solid #A83B32" : ATELIER_PANEL.borderLeft}}>
          <p className="text-[10px] tracking-[0.16em] uppercase mb-2" style={{color:salesPaused?T.error:T.gold}}>07 · Sales mode</p>
