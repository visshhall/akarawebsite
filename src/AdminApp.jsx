...
function AdminProducts(){
  ...
  return <div className="p-5 md:p-8">
    ...
    {(()=>{ const n=filtered.filter(p=>p.stock_qty==null&&p.stockQty==null&&p.status!=="draft"&&p.status!=="hidden").length; return n>0?<p className="text-[12.5px] mb-2 px-3 py-2" style={{backgroundColor:"rgba(181,101,29,0.1)",color:T.warning,borderRadius:8}}>{n} live product{n!==1?"s":""} without studio capacity — open each and set Stock quantity so customers see remaining units correctly.</p>:null; })()}
